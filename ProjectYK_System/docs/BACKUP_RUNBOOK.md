...
- ⚠️ **ชั้น Google Drive ยังไม่ทำงาน**: Google ตัดโควต้า storage ของ service account (2025) → SA อัปโหลดไฟล์ไม่ได้อีกแล้ว ทางแก้คือ OAuth บัญชีโอ (คลิกยินยอม 1 ครั้ง) — รอเคาะ; ระหว่างนี้สำเนานอกเครื่อง = ชั้น 3
