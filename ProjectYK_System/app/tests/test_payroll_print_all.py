...
def test_driver_slip_hides_kb_and_real_revenue(client_kb):
    ...
    # โอ 2ก.ค.: ค่าเที่ยวคนเหมาโชว์ "หลังหัก KB" ให้ตรงเงินที่จ่ายจริง
    # (engine จ่าย 3300 − 333×0.6 = 3100.2) — เลขดิบ 3,300 ต้องไม่โผล่แล้ว
    assert "3,100" in b or "3100" in b, "คนขับเหมาต้องเห็นค่าเที่ยวหลังหัก KB (ตรงที่จ่ายจริง)"
    assert "3,300" not in b and "3300" not in b, "ค่าเที่ยวก่อนหัก KB ต้องไม่โผล่"
