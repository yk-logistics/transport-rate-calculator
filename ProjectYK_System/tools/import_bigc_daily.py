...
CYCLES = {
    ...
    # เตรียมไว้ล่วงหน้า (7ก.ค.2026): ทีมยังไม่ส่งไฟล์ 7.Jul — ไฟล์มาเมื่อไหร่วางในโฟลเดอร์
    # แล้ว dry-run ได้ทันที (ห้ามลืม: รอบจ่าย ก.ค. ของ BigC = วิ่ง มิ.ย. T-1)
    "2026-06": {"folder": "7.Jul", "start": date(2026, 6, 1),  "end": date(2026, 6, 30)},
}
